...
const EMPTY: Fields = { email: "", password: "", firstName: "", lastName: "", phone: "" };
    ...
    create(
      ...
      },
      {
        onSuccess: (user) => {
          ...
          router.push("/admin/users?role=Patient");
        },
        onError: (err) => {
  ...
  return (
    <div style={{ maxWidth: 600 }}>
      <header style={{ marginBottom: "2rem" }}>
        ...
        <h1 style={{ color: "var(--ink)", margin: "0.25rem 0 0" }}>Add patient</h1>
      </header>
